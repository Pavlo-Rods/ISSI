  ...
  */
  ...
  return (
    ...
    <View style={styles.container}>
      <FlatList ListEmptyComponent={renderEmptyProductsList} showsVerticalScrollIndicator={false} data={restaurant.products} renderItem={renderProduct} keyExtractor={item => item.id.toString()}/>
    </View>
